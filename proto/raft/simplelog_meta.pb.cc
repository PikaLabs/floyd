...
void protobuf_AddDesc_raft_2fsimplelog_5fmeta_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\013entries_end\030\003 \002(\004", 179);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_raft_2fsimplelog_5fmeta_2eproto);
}
...
const MetaData& MetaData::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_raft_2fsimplelog_5fmeta_2eproto();
