...
void protobuf_AssignDesc_raft_2fraft_2eproto() {
  ...
  static const int RequestVote_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RequestVote, last_log_index_),
  };
  ...
  ResponseVote_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ResponseVote_descriptor_,
      ResponseVote::default_instance_,
      ResponseVote_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ResponseVote, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ResponseVote, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(ResponseVote));
  ...
  static const int AppendEntriesRequest_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AppendEntriesRequest, port_),
  ...
  static const int AppendEntriesResponse_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AppendEntriesResponse, status_),
...
ResponseVote* ResponseVote::New() const {
...
void ResponseVote::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const ResponseVote* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const ResponseVote*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
